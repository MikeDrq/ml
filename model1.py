...
class DenseNetOCR_Attn(nn.Module):
    def __init__(self, num_classes, nhead=8, num_layers=2, image_height=64, image_width=200):
        super().__init__()
        ...
        encoder_layer = nn.TransformerEncoderLayer(
            d_model=512, nhead=nhead, dim_feedforward=2048, dropout=0.1, batch_first=True
        )
